...
public class ManipulaString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Apenas o domínio: " + email.substring(email.indexOf("@")+1,email.indexOf(".com")));
		System.out.println("Primeira metade do e-mail: " + email.substring(0,email.length()/2));
		System.out.println("Comparação com case sensitive: " + email.equals("caio_giacomo@hotmail.com"));
		System.out.println("Comparação sem case sensitive: " + email.equalsIgnoreCase("caio_giacomo@hotmail.com"));
